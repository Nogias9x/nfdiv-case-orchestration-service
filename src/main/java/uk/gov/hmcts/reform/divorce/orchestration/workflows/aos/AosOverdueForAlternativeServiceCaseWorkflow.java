...
public class AosOverdueForAlternativeServiceCaseWorkflow extends DefaultWorkflow<Map<String, Object>> {
    ...
    public void run(String authToken, String caseId, AlternativeServiceType alternativeServiceType) throws WorkflowException {
        String eventToTrigger = getEventIdForGivenAlternativeServiceType(alternativeServiceType);
    ...
    private String getEventIdForGivenAlternativeServiceType(AlternativeServiceType alternativeServiceType) throws WorkflowException {
        if (SERVED_BY_PROCESS_SERVER.equals(alternativeServiceType)) {
            ...
            throw new WorkflowException("Unexpected value for alternative service type [" + alternativeServiceType + "]");
        }
    }
